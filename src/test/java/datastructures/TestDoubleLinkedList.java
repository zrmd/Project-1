...
public class TestDoubleLinkedList extends BaseTest {
    ...
    // adding a large number of ints (int)
    ...
    //makes sure you can add a lot of numbers quickly (int)
    ...
    //make sure you remove the last item (string)
    @Test(timeout=SECOND)
    ...
    //make sure you can remove a entire list (int)
    @Test(timeout=SECOND)
    ...
    //make sure you can add then remove (string)
    @Test(timeout=SECOND)
